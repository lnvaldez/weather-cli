...
print_bg_blue "Write air quality to file"
...
while true; do
    ...
    case "$format" in
        json)
            print_red "Executing: python -m src.cli coordinate 41.4086874 -75.6621294 --aqi --target file "
            print_separator
            python -m src.cli coordinate 41.4086874 -75.6621294 --aqi --target file
            ...
            ;;
        csv)
            print_red "Executing: python -m src.cli coordinate 41.4086874 -75.6621294 --aqi --format csv --target file"
            print_separator
            python -m src.cli coordinate 41.4086874 -75.6621294 --aqi --format csv --target file
            ...
            ;;
        txt)
            print_red "Executing: python -m src.cli coordinate 41.4086874 -75.6621294 --aqi --format txt --target file"
            print_separator
            python -m src.cli coordinate 41.4086874 -75.6621294 --aqi --format txt --target file
