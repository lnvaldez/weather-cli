...
while true; do
    ...
    case "$format" in
        json)
            print_red "Executing: python -m src.cli location Asuncion --aqi --target file "
            print_separator
            python -m src.cli location Asuncion --aqi --target file
            ...
            ;;
        csv)
            print_red "Executing: python -m src.cli location Asuncion --aqi --format csv --target file"
            print_separator
            python -m src.cli location Asuncion --aqi --format csv --target file
            ...
            ;;
        txt)
            print_red "Executing: python -m src.cli location Asuncion --aqi --format txt --target file"
            print_separator
            python -m src.cli location Asuncion --aqi --format txt --target file
