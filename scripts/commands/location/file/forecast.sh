...
print_bg_blue "Write 5-day forecast to file"
...
while true; do
    ...
    case "$format" in
        json)
            print_red "Executing: python -m src.cli location Asuncion --forecast --target file "
            print_separator
            python -m src.cli location Asuncion --forecast --target file
            ...
            ;;
        csv)
            print_red "Executing: python -m src.cli location Asuncion --forecast --format csv --target file"
            print_separator
            python -m src.cli location Asuncion --forecast --format csv --target file
            ...
            ;;
        txt)
            print_red "Executing: python -m src.cli location Asuncion --forecast --format txt --target file"
            print_separator
            python -m src.cli location Asuncion --forecast --format txt --target file
