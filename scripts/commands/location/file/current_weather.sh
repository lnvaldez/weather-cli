...
while true; do
    ...
    case "$format" in
        json)
            print_red "Executing: python -m src.cli location Asuncion --current --target file "
            print_separator
            python -m src.cli location Asuncion --current --target file
            ...
            ;;
        csv)
            print_red "Executing: python -m src.cli location Asuncion --current --format csv --target file"
            print_separator
            python -m src.cli location Asuncion --current --format csv --target file
            ...
            ;;
        txt)
            print_red "Executing: python -m src.cli location Asuncion --current --format txt --target file"
            print_separator
            python -m src.cli location Asuncion --current --format txt --target file
