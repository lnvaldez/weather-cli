...
print_bg_blue "Write sunset and sunrise times to file"
...
while true; do
    ...
    case "$format" in
        json)
            print_red "Executing: python -m src.cli location Asuncion --sun --target file "
            print_separator
            ...
            ;;
        csv)
            print_red "Executing: python -m src.cli location Asuncion --sun --format csv --target file"
            print_separator
            python -m src.cli location Asuncion --sun --format csv --target file
            ...
            ;;
        txt)
            print_red "Executing: python -m src.cli location Asuncion --sun --format txt --target file"
            print_separator
            python -m src.cli location Asuncion --sun --format txt --target file
